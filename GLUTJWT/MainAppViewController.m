...
- (void)viewDidLoad
{
    ...
    //首页图片
    UIImageView * homeView =[[UIImageView alloc]initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height * 0.5)];
    homeView.image = [UIImage imageNamed:@"homes560.png"];
    [self.view addSubview:homeView];
    
    //底部背影
    UIImageView * buttomView =[[UIImageView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height * 0.5 + 64 , self.view.frame.size.width, self.view.frame.size.height * 0.5)];
    ...
    //校训
    //厚德笃学 惟实励新
    UIButton * qifeBtn = [[UIButton alloc ]initWithFrame:CGRectMake(5, self.view.center.y * 4.9/4 + 45, self.view.frame.size.width / 2 - 10, self.view.frame.size.height * 0.15)];
    ...
    //笃学
    UIButton * qishiBtn = [[UIButton alloc ]initWithFrame:CGRectMake(self.view.frame.size.width /2, self.view.center.y * 4.9/4 + 45, self.view.frame.size.width /2 - 10, self.view.frame.size.height * 0.15)];
    ...
    //惟实
    UIButton * qisiBtn = [[UIButton alloc ]initWithFrame:CGRectMake(5, self.view.center.y * 4.9/4 + 48 + self.view.frame.size.height * 0.16, self.view.frame.size.width / 2 -10, self.view.frame.size.height * 0.15)];
    ...
    //励新
    UIButton * kaitoBtn = [[UIButton alloc ]initWithFrame:CGRectMake(self.view.frame.size.width /2 ,self.view.center.y * 4.9/4 + 48 + self.view.frame.size.height * 0.16, self.view.frame.size.width /2 - 10, self.view.frame.size.height * 0.15)];
