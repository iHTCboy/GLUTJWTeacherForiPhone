...
- (void)setupScrollView
{
    ...
    for (int index = 0; index< showImageCount; index++) {
        ...
        {
            name = [NSString stringWithFormat:@"show0%d", index + 1];
        }
...
- (void)setupLastImageView:(UIImageView *)imageView
{
    ...
    startButton.frame = CGRectMake(self.view.frame.size.width * 0.1, self.view.center.y * 1.1/2 + 140, self.view.frame.size.width * 0.8, 40);
