...
- (void)viewDidLoad
{
    ...
    UIView *listV = [[UIView alloc] initWithFrame:CGRectMake( 0, 30, self.view.frame.size.width, self.view.frame.size.height - 30)];
    ...
    listTable.separatorColor = TCCoror(159,5,13);
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text =jwInfoList[rowNow][0];
    ...
    cell.selectedBackgroundView.backgroundColor = TCCoror(159,5,13);
...
//    {
//        //获取我的课表的URL信息
//        NSURL * url =[NSURL URLWithString:@"http://202.193.80.58/academic/student/currcourse/currcourse.jsdo?groupId=&moduleId=2000"];
//        
