...
- (void)viewDidLoad
{
    ...
    switch (self.tag)
    {
        ...
        case 2:
        {
            ...
            name.center = CGPointMake(self.view.frame.size.width * 0.5, self.view.frame.size.height * 0.3);
            ...
            version.center = CGPointMake(self.view.frame.size.width * 0.5, self.view.frame.size.height * 0.336);
            ...
            info.frame  = CGRectMake(0,self.view.frame.size.height * 0.35, self.view.frame.size.width, self.view.frame.size.height - self.view.frame.size.height * 0.35);
